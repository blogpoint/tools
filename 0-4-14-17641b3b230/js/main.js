(function () {
     ...
     * @param p_previewslabProjectObj previewslabProjectObj|null - project you want previewslab to start with. null -> empty canvas
     * @returns {HTMLDivElement}
     * @constructor
     */
    function PCWeb(p_w, p_h, p_previewslabProjectObj) {
        ...
        var previewslabMaxCanvasSize = Math.min(4096, Math.max(2048, Math.max(window.screen.width, window.screen.height)));
        ...
        var pcCanvas = new BV.PcCanvas(
            p_previewslabProjectObj ? {
                projectObj: p_previewslabProjectObj
            } : {
                width: Math.min(previewslabMaxCanvasSize, window.innerWidth < collapseThreshold ? width : width - toolwidth),
                height: Math.min(previewslabMaxCanvasSize, height)
            });
        pcCanvas.setLogger(BV.pcLog);
        var initState = {};

        if (p_previewslabProjectObj) {
            setTimeout(function() {
        ...
        function importFinishedLoading(importedImage, optionStr) {
            ...
            function getResizedDimensions(width, height) {
                ...
                if (w > previewslabMaxCanvasSize) {
                    h = previewslabMaxCanvasSize / w * h;
                    w = previewslabMaxCanvasSize;
                }
                if (h > previewslabMaxCanvasSize) {
                    w = previewslabMaxCanvasSize / h * w;
                    h = previewslabMaxCanvasSize;
                }
                w = parseInt(w);
                h = parseInt(h);
                return {
            ...
            if(optionStr === 'default' || !optionStr) {
                BV.showImportImageDialog({
                    image: importedImage,
                    target: pcWeb,
                    maxSize: previewslabMaxCanvasSize,
        ...
        setTimeout(function() {
            overlayToolspace = new BV.OverlayToolspace({
                enabledTest: function() {
                    return !PREVIEWSLAB.isInDialog && !lineSanitizer.getIsDrawing();
                },
                    ...
                    button.onclick = function () {
                        ...
                        if (!filterArr[filterKey].isInstant) {
                            ...
                            let filterDialog = filterArr[filterKey].getDialog({
                                context: currentLayerCtx,
                                canvas: pcCanvas,
                                maxWidth: previewslabMaxCanvasSize,
                                maxHeight: previewslabMaxCanvasSize,
        ...
        function showNewImageDialog() {
            BV.newImageDialog({
                ...
                secondaryColor: pcColorSlider.getSecondaryRGB(),
                maxCanvasSize: previewslabMaxCanvasSize,
        ...
        function shareImage(callback) {
            BV.shareCanvas({
                ...
                fileName: BV.getDate() + 'previewslab.png',
                title: BV.getDate() + 'previewslab.png',
        ...
        function createFileDiv() {
            ...
            function asyncCreation() {
                ...
                storebutton.onclick = function () {
                    ...
                    function store(previewslabProjectObj) {

                        BV.browserStorage.storepreviewslabProjectObj(previewslabProjectObj, function() {
                            ...
                            BV.popup({
                                ...
                                type: "ok",
                                message: [
                                    "<b>Current state</b> of your image is stored in this browser. It will be loaded again upon reopening previewslab with this browser on this device.",
                                    '',
                                    '<b>Important:</b>',
                            ...
                            storebutton.textContent = 'Store';
                            setTimeout(function() {
                                throw 'storepreviewslabProjectObj error, ' + errorStr;
                            })
                            BV.popup({
                                target: pcWeb,
                                type: "error",
                    ...
                    pcCanvas.getpreviewslabProjectObj(store, function(errorStr) {
                        storebutton.disabled = false;
                        storebutton.textContent = 'Store';
                        BV.popup({
                            target: pcWeb,
                        ...
                        setTimeout(function() {
                            throw 'PcCanvas.getpreviewslabProjectObj error, ' + errorStr;
                        }, 0);
                    });
                };
                ...
                uploadInkButton.onclick = function () {
                    ...
                    var e = this;
                    var fpf = {
                        url: "https://previewslab.com/0-4-14-17641b3b230/img/blank_for_filepicker.png",
                        filename: BV.getDate() + "previewslab",
                        mimetype: "image/png",
                        isWriteable: true
                    };
        ...
        function saveImageToComputer() {
            ...
            if (exportType === 'png') {
                ...
                let filename = BV.getDate() + "previewslab." + extension;
                ...
                let extension = 'png';
                let mimeType = 'image/png';
                let fileBase = BV.getDate() + "previewslab";
                ...
                for (let i = 0; i < layerArr.length; i++) {
                    ...
                    psdConfig.children.push({
                        ...
                        canvas: item.canvas,
                        blendMode: BV.PSD.blendpreviewslabToPsd(item.mixModeStr),
                        left: 0,
                        top: 0
                    });
                }
                ...
                saveAs(blob, BV.getDate() + 'previewslab.psd');
    ...
    var showFeedbackDialog = function (target) {
        ...
        var boxSize = 50;
        var inputDescription = document.createElement("textarea");
        inputDescription.className = "previewslab-textarea";
        ...
        emailInput.className = "previewslab-input";
        ...
        messageInfoEl.onclick = function() {
            let contentArr = [
                ...
                '',
                'previewslab version: ' + PREVIEWSLAB.version,
                '',
                'user agent: ' + navigator.userAgent,
                '',
                'version hash: ' + PREVIEWSLAB.versionHash,
            ];
            ...
            callback: function (val) {
                ...
                if (val === "Submit") {
                    if (inputDescription.value != "") {
                        sendFeedback(inputDescription.value, emailInput.value, PREVIEWSLAB.version, PREVIEWSLAB.versionHash);
                    }
                } else if (val === "Cancel") {
                }
            }
    ...
    (function() {
        ...
        //DOMContentLoaded -> onDomLoaded -> onpreviewslabProjectObjLoaded

        function onpreviewslabProjectObjLoaded(previewslabProjectObj) {
            if(PREVIEWSLAB.isInitialized) {
                throw 'onpreviewslabProjectObjLoaded called more than once';
            }
            ...
            pcWeb = new PCWeb(window.innerWidth, window.innerHeight, previewslabProjectObj);
            ...
            previewslabProjectObj = null;
            PREVIEWSLAB.isInitialized = true;
            PREVIEWSLAB.onInit();
        }
        ...
        function onDomLoaded() {
            ...
            BV.browserStorage.getpreviewslabProjectObj(function(previewslabProjectObj) {
                onpreviewslabProjectObjLoaded(previewslabProjectObj);
            }, function(errorStr) {
                onpreviewslabProjectObjLoaded(null);
                setTimeout(function() {
                    pcWeb.showMessage('Failed to restore from Browser Storage');
                    throw 'getpreviewslabProjectObj() error, ' + errorStr;
                }, 100);
            });
        }
    ...
    setInterval(function () {
        ...
        if(PREVIEWSLAB.lastReminderResetAt + reminderTimelimitMs < (performance.now()) && loggerDist >= 50) {
            resetSaveReminder();
    ...
    function resetSaveReminder() {
        PREVIEWSLAB.lastReminderResetAt = performance.now();
